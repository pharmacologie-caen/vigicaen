...
This outlines how to propose a change to vigicaen. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("pharmacologie-caen/vigicaen", fork = TRUE)`.
...
Code of
Conduct](https://pharmacologie-caen.github.io/vigicaen/CODE_OF_CONDUCT.md).
