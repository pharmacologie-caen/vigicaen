...
[![CRAN status](https://www.r-pkg.org/badges/version/vigicaen)](https://CRAN.R-project.org/package=vigicaen)
<!-- badges: end -->
...
ggplot2::ggsave(here::here("man", "figures", "vg.png"), plot = g1, height = 7.5, width = 4)
```

```{r include_graph, echo = FALSE, out.width="384px"}
#| fig.alt: >
#|   Example of vigi_routine with case data.

knitr::include_graphics(here::here("man", "figures", "vg.png"))
```
...
Please note that the vigicaen project is released with a [Contributor Code of Conduct](https://pharmacologie-caen.github.io/vigicaen/CODE_OF_CONDUCT.html). 
