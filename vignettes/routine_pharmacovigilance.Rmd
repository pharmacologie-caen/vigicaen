...
```{r vigi_routine_case, fig.height=7.5, fig.width=4}
vigi_routine(
  case_tto  = 150,
  demo_data = demo,
  drug_data = drug,
...
Suppose you want to analyze only cases where both nivolumab and ipilimumab were taken, for the same adverse event:
