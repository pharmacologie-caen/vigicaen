...
```{r vigi_routine, fig.height=7.5, fig.width=4}
#| fig.alt: >
...
```{r vigi_routine_case, fig.height=7.5, fig.width=4, eval = FALSE}
vigi_routine(
  case_tto  = 150,
  demo_data = demo,
  drug_data = drug,
...
```{r vigi_routine_case_render, echo = FALSE, message = FALSE, include = FALSE}
...
ggplot2::ggsave(here::here("man", "figures", "vigi_routine_case_render.png"), plot = g1, height = 7.5, width = 4)
```

```{r vigi_routine_case_graph, echo = FALSE, fig.height=7.5, fig.width=4}
#| fig.alt: >
#|   Example of vigi_routine with case data.

knitr::include_graphics(here::here("man", "figures", "vigi_routine_case_render.png"))
```
