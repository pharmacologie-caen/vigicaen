...
demo <- open_dataset(paste0(path_base, "demo.parquet"))
drug <- open_dataset(paste0(path_base, "drug.parquet"))
adr  <- open_dataset(paste0(path_base, "adr.parquet" ))
link <- open_dataset(paste0(path_base, "link.parquet"))
