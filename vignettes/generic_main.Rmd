...
demo     <- read_parquet(paste0(path_base, "demo.parquet"))
adr      <- read_parquet(paste0(path_base, "adr.parquet"))
drug     <- read_parquet(paste0(path_base, "drug.parquet"))
link     <- read_parquet(paste0(path_base, "link.parquet"))
out      <- read_parquet(paste0(path_base, "out.parquet"))
srce     <- read_parquet(paste0(path_base, "srce.parquet"))
followup <- read_parquet(paste0(path_base, "srce.parquet"))

suspdup  <- read_parquet(paste0(path_base, "suspdup.parquet"))

thg      <- read_parquet(paste0(path_who, "thg.parquet")) |> collect()
mp_short <- read_parquet(paste0(path_who, "mp_short.parquet")) |> collect()
```

Make sure to `dplyr::collect()` these datasets if you want to work **IN**-memory.
